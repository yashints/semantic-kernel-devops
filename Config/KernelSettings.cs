...
internal class KernelSettings
{
  ...
  private static string DefaultConfigFile = "Config/appsettings.json";
  ...
  [JsonPropertyName("chatOrModelId")]
  ...
  internal static KernelSettings LoadSettings()
  {
    try
    {
      ...
      if (env != null)
      {
        DefaultConfigFile = $"Config/appsettings.{env}.json";
      }
  ...
  /// </summary>
  internal static KernelSettings FromFile(string configFile)
  {
    ...
    return configuration.GetSection("KernelSettings").Get<KernelSettings>()
